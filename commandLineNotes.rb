...
# This cheat sheet works with about every distribution, except for apt-get which is Ubuntu/Debian exclusive.
...
# Installing software:
# When software is available in the repositories: sudo apt-get install <nameOfSoftware>
